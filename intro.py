...
def intro_three(player):
    slowprint(f"Hello {player}\n I know that you are feeling courageous but before you begin your adventure,\n I would"
              ...
              f" gods and monsters.\nUnlike the Gods,Goddesses and monsters of your world there is not good Gods,"
              f"Goddesses or "
              f"monsters, "
              ...
              f" mankind.\n There have been many Champions before you, some could lift mountains with a single "
              f"thought,\n "
              f"while others were gifted in brute strength and could punch a whole through an active Volcano.\n Although"
              f" these champions were mighty, \n They never achieved their goal, which was to kill all of the "
              f"pantheons\n "
